package hector.lagunas.ejemplo06recyclerview;
...
import hector.lagunas.ejemplo06recyclerview.adapters.ToDoAdapter;
import hector.lagunas.ejemplo06recyclerview.databinding.ActivityMainBinding;
import hector.lagunas.ejemplo06recyclerview.modelos.ToDo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void crearTareas() {
        for (int i = 0; i < 1000000; i++) {
            todoList.add(new ToDo("Titulo "+i, "Contenido "+1));
        }
    }
